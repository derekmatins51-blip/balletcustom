        ...
        <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/50 overflow-hidden">
            <div class="border-b border-gray-200/50 dark:border-gray-700/50 px-6 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('user.ballet-cards.link.form') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white rounded-xl shadow-lg font-semibold transition-all duration-300 transform hover:scale-[1.02]">
                        <i class="fas fa-link mr-2"></i> Link Ballet Card
                    </a>
                </div>
            </div>
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6 max-w-sm mx-auto">Get started by applying for your first virtual card or link your Ballet Card. It only takes few minutes!</p>
