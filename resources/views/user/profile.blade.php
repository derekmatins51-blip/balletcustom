...
<div x-data="{ 
            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-white/20 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="p-3">
                    <nav class="space-y-1">
                        ...
                        <button @click="showUpdatePhraseModal = true" class="w-full flex items-center px-3 py-2 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 font-medium text-xs text-left transition-colors">
                            <i class="fa-solid fa-quote-right text-xs mr-2"></i>
                            <span>Update Ballet Phrase</span>
                        </button>
                    </nav>
                </div>
            </div>
            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-white/20 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="p-4">
                    <form action="#" method="post" class="space-y-4">
                        ...
                        <!-- Phrase -->
                        <div>
                            <label for="phrase" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Ballet Phrase</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i class="fa-solid fa-quote-right text-gray-400 text-xs"></i>
                                </div>
                                <input 
                                    type="text" 
                                    id="phrase" 
                                    name="phrase"
                                    class="block w-full pl-8 py-2 text-xs border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    value="{{ Auth::user()->phrase }}" 
                                    readonly
                                />
                            </div>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Your Unique Ballet Phrase.</p>
                        </div>
    ...
    <div 
        ...
        x-transition:leave-end="opacity-0"
    >
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm" @click="showUpdatePhraseModal = false"></div>
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-2xl border border-gray-200 dark:border-gray-700"
            ...
            <div class="p-4">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-sm font-bold text-gray-900 dark:text-white">Update Ballet Phrase</h3>
                    <button @click="showUpdatePhraseModal = false" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                        <i class="fa-solid fa-times text-sm"></i>
                    </button>
                </div>
                
                <form action="{{ route('updatephrase') }}" method="post" class="space-y-3">
                    @csrf
                    @method('PUT')
                    
                    <div>
                        <label for="phrase_input" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">New Ballet Phrase</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fa-solid fa-quote-right text-gray-400 text-xs"></i>
                            </div>
                            <input 
                                ...
                                name="phrase"
                                class="block w-full pl-8 py-2 text-xs border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                placeholder="Enter your new Ballet Phrase"
                                maxlength="20"
                                pattern="[A-Za-z0-9]{20}"
                                required
                            />
                        </div>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Unique Ballet Phrase Only.</p>
                    </div>
                    
                    <div>
                        <label for="current_password_phrase" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Current Password</label>
                        <div class="relative" x-data="{ showPassword: false }">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fa-solid fa-lock text-gray-400 text-xs"></i>
                            </div>
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-3 border border-yellow-100 dark:border-yellow-800/50">
                        <div class="flex">
                            ...
                            <div class="ml-2">
                                <h3 class="text-xs font-medium text-yellow-800 dark:text-yellow-300">Security Alert</h3>
                                <p class="mt-1 text-xs text-yellow-700 dark:text-yellow-400">
                                    Your Ballet Phrase is a critical security measure. Keep it confidential.
                                </p>
                            </div>
                        </div>
                    </div>
