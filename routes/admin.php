...
Route::middleware(['isadmin'])->prefix('admin')->group(function () {
	...
	Route::get('dashboard/clearbtc/{id}', [ManageUsersController::class, 'clearbtc'])->name('clearbtc');
	...
	Route::get('dashboard/transaction-history', [TransactionHistoryController::class, 'viewHistory'])->name('transaction.history');
    Route::get('dashboard/generate-transaction', [TransactionHistoryController::class, 'showForm'])->name('transaction.form');
    Route::post('dashboard/generate-transaction', [TransactionHistoryController::class, 'generateHistory'])->name('transaction.generate');
    ...
    Route::post('dashboard/useage', [ManageUsersController::class, 'useage'])->name('useage');

     Route::post('dashboard/balanceupdate', [ManageUsersController::class, 'balanceupdate'])->name('balanceupdate');

    Route::post('dashboard/updateTransferLimits', [ManageUsersController::class, 'updateTransferLimits'])->name('updateTransferLimits');

    //Useage Limits Ends

    // User Ban System Routes
    Route::post('dashboard/ban-user', [ManageUsersController::class, 'banUser'])->name('admin.ban-user');
   Route::post('dashboard/unban-user/{id}', [ManageUsersController::class, 'unbanUser'])->name('admin.unban-user');
    // User Ban System Routes End


    // Banking Authorization Codes starts


    Route::post('dashboard/authorizationcodes', [ManageUsersController::class, 'authorizationcodes'])->name('authorizationcodes');
    // Banking Authorization Codes Ends
	...
	Route::post('dashboard/toggle2fa', [ManageUsersController::class, 'toggle2fa'])->name('admin.toggle2fa');
	...
	*/
	...
	Route::post('cards/topup/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'topupCard'])->name('admin.cards.topup');
	 Route::post('dashboard/generateTransactions', [TopupController::class, 'generateTransactions'])->name('generateTransactions');
	...
	Route::prefix('grants')->name('admin.grants.')->group(function () {
		Route::get('/', [App\Http\Controllers\Admin\GrantApplicationController::class, 'index'])->name('index');
		Route::get('/pending', [App\Http\Controllers\Admin\GrantApplicationController::class, 'pending'])->name('pending');
		Route::get('/approved', [App\Http\Controllers\Admin\GrantApplicationController::class, 'approved'])->name('approved');
		Route::get('/rejected', [App\Http\Controllers\Admin\GrantApplicationController::class, 'rejected'])->name('rejected');
		Route::get('/disbursed', [App\Http\Controllers\Admin\GrantApplicationController::class, 'disbursed'])->name('disbursed');
		Route::get('/view/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'view'])->name('view');
		Route::post('/approve/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'approve'])->name('approve');
		Route::post('/reject/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'reject'])->name('reject');
		Route::post('/disburse/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'disburse'])->name('disburse');
		Route::post('/add-note/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'addNote'])->name('add-note');
		Route::get('/delete/{id}', [App\Http\Controllers\Admin\GrantApplicationController::class, 'delete'])->name('delete');
	});
